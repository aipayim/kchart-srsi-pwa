...
window.ruleOptimizeRun = () => kchartApi.ruleOptimizeRun();
window.ruleOptimizeApply = () => kchartApi.ruleOptimizeApply();
window.ruleVersionSwitch = () => kchartApi.ruleVersionSwitch();
